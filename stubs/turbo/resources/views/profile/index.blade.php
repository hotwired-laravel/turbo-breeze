<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <x-turbo-frame id="{{ $frame ?? 'profile_menu' }}" target="_top">
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg space-y-6 [&>a]:first-of-type:[&_li]:rounded-t-lg [&>button]:first-of-type:[&_li]:rounded-t-lg [&>a]:last-of-type:[&_li]:rounded-b-lg [&>button]:last-of-type:[&_li]:rounded-b-lg">
